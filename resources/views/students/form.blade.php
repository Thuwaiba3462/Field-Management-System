...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Start your registration </h1>
		...
		<div class="title ">STUDENT REGISTRATION FORM</div>
		   ...
		   <div class="input-box">
                           ...
                           <div class="input-box">
	                             <span class="user-details">Password_Confirmation</span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy;Thuwaiba Your Website 2023</span>
                    </div>
                </div>
            </footer>
